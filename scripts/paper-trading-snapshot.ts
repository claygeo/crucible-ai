...
async function main() {
  ...
  const rowsArtifact = {
    ...
    selected_bankroll_risk: snapshot.selected_bankroll_risk,
    selected_open_outcome_scenarios: snapshot.selected_open_outcome_scenarios,
    agent_edge_matrix: snapshot.agent_edge_matrix,
